...
description: "Cover identity, datum, allowance, stress raisers, burrs, surface, inspection, protection, and traceability"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Drilling, Threading, dan Keyway pada Bar”
- **Reader and situation:** Machinist preparing a part
- **Reader outcome:** Cover identity, datum, allowance, stress raisers, burrs, surface, inspection, protection, and traceability
- **Primary intent:** Plan features
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not design features or give parameters; drawing/route own them
- **Final public route:** `/artikel/drilling-threading-dan-keyway-bar.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Drilling, Threading, dan Keyway pada Bar**.
...
- **Tie back to this article:** Keep the explanation specific to “Drilling, Threading, dan Keyway pada Bar”.
