...
description: "Compare piece count, theoretical mass, weighbridge/tare, packaging, tolerance, and contract basis"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Berat Teoretis, Timbangan, dan Invoice”
- **Reader and situation:** Buyer finding mass variance
- **Reader outcome:** Compare piece count, theoretical mass, weighbridge/tare, packaging, tolerance, and contract basis
- **Primary intent:** Reconcile quantity
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Payment entitlement belongs to procurement BESB-12-A01
- **Final public route:** `/artikel/rekonsiliasi-berat-bar-stock.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Berat Teoretis, Timbangan, dan Invoice**.
...
- `BESB-03-A06` → `/artikel/spesifikasi-calculator-besi-batangan.html` — Calculator Besi Batangan yang Bisa Diaudit
...
- **Tie back to this article:** Keep the explanation specific to “Berat Teoretis, Timbangan, dan Invoice”.
