...
description: "Explain shrinkage, restraint, sequence, fit-up, symmetry, measurements, trials, and correction controls"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Distorsi saat Mengelas Round dan Square Bar”
- **Reader and situation:** Fabricator assembling bar components
- **Reader outcome:** Explain shrinkage, restraint, sequence, fit-up, symmetry, measurements, trials, and correction controls
- **Primary intent:** Plan distortion control
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Sobat Besi.co.id`
- **Natural variants:** `Kawan Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** No sequence/straightening instruction; approved procedure owns it
- **Final public route:** `/artikel/distorsi-pengelasan-bar.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Distorsi saat Mengelas Round dan Square Bar**.
...
- **Tie back to this article:** Keep the explanation specific to “Distorsi saat Mengelas Round dan Square Bar”.
