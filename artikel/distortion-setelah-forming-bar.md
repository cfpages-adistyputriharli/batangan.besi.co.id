...
description: "Explain elastic recovery, section distortion, straight portions, twist, surface defects, and measurement"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Springback, Ovality, dan Distortion setelah Forming”
- **Reader and situation:** Inspector checking bent/twisted stock
- **Reader outcome:** Explain elastic recovery, section distortion, straight portions, twist, surface defects, and measurement
- **Primary intent:** Inspect formed geometry
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Kawan Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Teman Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Acceptance belongs to drawing/ITP BESB-12-A02
- **Final public route:** `/artikel/distortion-setelah-forming-bar.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Springback, Ovality, dan Distortion setelah Forming**.
...
- **Tie back to this article:** Keep the explanation specific to “Springback, Ovality, dan Distortion setelah Forming”.
