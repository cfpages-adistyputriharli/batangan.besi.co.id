...
description: "Map activity, characteristic, criterion source, method, frequency, responsibility, hold/witness, record, NCR, release"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “ITP Material dan Proses Besi Batangan”
- **Reader and situation:** Owner controlling supply/fabrication
- **Reader outcome:** Map activity, characteristic, criterion source, method, frequency, responsibility, hold/witness, record, NCR, release
- **Primary intent:** Build QA plan
- **Reader community:** `Besi.co.id`
- **Primary friendly address:** `Teman Besi.co.id`
- **Natural variants:** `Sobat Besi.co.id` and `Kawan Besi.co.id`
- **Address cadence:** use a friendly project-community address three to five times in a typical long article, only at natural conversational pivots.
- **Scope boundary:** Does not invent criteria; approved specification owns them
- **Final public route:** `/artikel/itp-besi-batangan.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **ITP Material dan Proses Besi Batangan**.
...
- **Tie back to this article:** Keep the explanation specific to “ITP Material dan Proses Besi Batangan”.
